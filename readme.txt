...
Integrates with the wonderful [subscribe2](https://wordpress.org/plugins/subscribe2/ "subscribe2") and [replyPUSH.com](http://replypush.com "replyPUSH.com") service to provide the email reply magic.
...
== Installation ==
1. Sign up at [replyPUSH](http://beta.replypush.com/signup "replyPUSH").
...
1. Carefully copy over from replyPUSH the `Account No`, `Secret ID` and `Secret Key` to the fields provided. Save the form.
